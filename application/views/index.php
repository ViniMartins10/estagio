...
<body class="h-100 bg-primary">
        ...
        <div class="content bg-light">
            ...
            <form method="post">
                <div class="form-group mb-4">
                    <label for="loginTxt" class="control-lanbel">Usuário:</label>
                ...
                <div class="row m-0 p-0 mt-2">
                    <button type="button" id="cadastrarBtn" class="btn btn-primary btn-block">
                        CADASTRAR
                    </button>
                </div>
            </form>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function() {
            ...
            // Adicione um evento para o botão de cadastro
            $('#cadastrarBtn').on('click', function() {
                // Redirecione para a página de cadastro
                window.location.href = '<?=base_url('funcoes/cadastrar')?>';
            });
        });
    </script>
</body>
